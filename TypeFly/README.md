...
If you are using Spark (by default), you should also pass an interface to contact the drone and the URL of the DJIControlServer:
```bash
make typefly INTERFACE=172.26.255.87 URL=http://192.168.1.20:8080
```
For more Spark usage details, please refer to [spark-usage.md](spark-usage.md).
