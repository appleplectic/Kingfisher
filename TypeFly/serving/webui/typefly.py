...
class TypeFly:
    def __init__(self, robot_type, use_http=False, spark_url: str=None, spark_interface: str=None):
        ...
        self.llm_controller = LLMController(robot_type, use_http, self.message_queue, spark_url, spark_interface)
...
if __name__ == "__main__":
    ...
    typefly = TypeFly(robot_type, args.use_http, args.url, args.interface)
    typefly.run()